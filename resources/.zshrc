...
# export VAGRANT_WSL_WINDOWS_ACCESS_USER_HOME_PATH="/mnt/d/Documents/Vagrant"
 
# export PATH="$PATH:/mnt/c/Program Files/Oracle/VirtualBox"
export PATH="$PATH:/home/lucndm/.local/bin/"
 
# export DOCKER_HOST=tcp://localhost:2375
export DOCKER_HOST=unix:///var/run/docker.sock
 
export PATH="/home/lucndm/.pyenv/bin:$PATH"
eval "$(pyenv init -)"
...
function swe() {
        case $1 in
                lucndm-gcp )   gcloud config set project lucndm-gcp
                                ;;
                ai-lab) gcloud config set project ai-lab-201911
                        gcloud container clusters get-credentials demo --zone=asia-northeast1-a
#           gcloud config set dataproc/region asia-southeast1
            ...
            gcloud config set dataproc/region asia-southeast1
                        ;;
                qa )    gcloud config set project veep-staging
